...
uint256 hashGenesisBlock("0x77c60d41d222b038c52aa2cdd43b6648db235d1117a470da8ab3937e012059e3");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Kickasscoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Kickasscoin Signed Message:\n";
...
{
    int64 nSubsidy = 100 * COIN; // Kickasscoin: 100 (Litecoin: 50)

    // Subsidy is cut in half every 800000 blocks
    nSubsidy >>= (nHeight / 800000); // Kickasscoin: 800k blocks in ~1 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan_Version1 = 60 * 30; // Kickasscoin: 30 seconds
static const int64 nTargetSpacing = 30; // Kickasscoin: 30 seconds
static const int64 nInterval_Version1 = nTargetTimespan_Version1 / nTargetSpacing; // Kickasscoin: 45 blocks

static const int64 nHeight_Version2 = 208440;
static const int64 nInterval_Version2 = 15;
static const int64 nTargetTimespan_Version2 = nInterval_Version2 * nTargetSpacing; // minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal kickasscoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Kickasscoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x77c60d41d222b038c52aa2cdd43b6648db235d1117a470da8ab3937e012059e3");
    }
    ...
    if (mapBlockIndex.empty())
    {
		...
		//   CTransaction(hash=730f0c8ddc, ver=2, vin.size=1, vout.size=1, nLockTime=0, strTxComment=text:Kickasscoin genesis block)
        ...
        // Genesis block
        const char* pszTimestamp = "i got knocked up";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710fa689ad5023000c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
		txNew.strTxComment = "text:Kickasscoin genesis block";
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1388820825;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1000449135;
        ...
        assert(block.hashMerkleRoot == uint256("0xce860c8d8302934c3156866acf16899b431c7d4ba2c5c0d43ccefbf19436ad13"));
