...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "<html><head/><body><p>The address to send the payment to  (e.g. KyhM3UpgFZnXzJ5zux1AWQvAE36rFJKMs7)</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
